...
import 'package:flutter_authentication/widgets/custom_category_filter.dart';
import 'package:flutter_authentication/widgets/custom_price_filter.dart';
...
class FilterScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar:
            AppBar(backgroundColor: Color(0xFFFE3C5B), title: Text('Filter')),
